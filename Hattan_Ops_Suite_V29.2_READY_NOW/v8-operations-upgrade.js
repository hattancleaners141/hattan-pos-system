...
receiptTicketHTML = function v8ReceiptTicketHTML(o){
  ...
  const isDelivery=o.fulfillment==='delivery'||o.channel==='delivery',apt=String(a?.apartment||'').trim(),topUnit=isDelivery?(apt||'DELIVERY'):'';
