# V28.2.5 Counter Workflow

Adds dry-clean material/special-direction buttons, linked alteration intake, expanded Wash & Fold preferences, large per-ticket due-date controls, customer-profile fulfillment defaults, and pay-later/card-on-file checkout controls.
