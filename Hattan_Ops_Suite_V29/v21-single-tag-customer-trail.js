...
const V21_TAG_SERVICES = new Set(['dryclean', 'alterations']);
...
v12RenderTags = function v21RenderTags(content) {
  ...
  content.innerHTML = `
    <div class="pos-card v12-tag-scan-card">
      <div class="v12-section-head"><div><h3>${icon('tag',17)} Tag Assign — one tag per ticket</h3><div class="v2-note">Dry Cleaning and Tailoring / Alterations use one physical tag number after intake. Laundered Shirts and Wash &amp; Fold do not require tag assignment; they go directly to rack assignment.</div></div><span class="v12-count-badge">${needCount} need one tag</span></div>
